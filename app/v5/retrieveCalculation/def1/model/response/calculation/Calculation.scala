...
import v5.retrieveCalculation.def1.model.response.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v5.retrieveCalculation.def1.model.response.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v5.retrieveCalculation.def1.model.response.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v5.retrieveCalculation.def1.model.response.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v5.retrieveCalculation.def1.model.response.calculation.dividendsIncome.DividendsIncome
import v5.retrieveCalculation.def1.model.response.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v5.retrieveCalculation.def1.model.response.calculation.employmentExpenses.EmploymentExpenses
import v5.retrieveCalculation.def1.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v5.retrieveCalculation.def1.model.response.calculation.foreignIncome.ForeignIncome
import v5.retrieveCalculation.def1.model.response.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v5.retrieveCalculation.def1.model.response.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v5.retrieveCalculation.def1.model.response.calculation.giftAid.GiftAid
import v5.retrieveCalculation.def1.model.response.calculation.incomeSummaryTotals.IncomeSummaryTotals
import v5.retrieveCalculation.def1.model.response.calculation.lossesAndClaims.LossesAndClaims
import v5.retrieveCalculation.def1.model.response.calculation.marriageAllowanceTransferredIn.MarriageAllowanceTransferredIn
import v5.retrieveCalculation.def1.model.response.calculation.notionalTax.NotionalTax
import v5.retrieveCalculation.def1.model.response.calculation.otherIncome.OtherIncome
import v5.retrieveCalculation.def1.model.response.calculation.pensionContributionReliefs.PensionContributionReliefs
import v5.retrieveCalculation.def1.model.response.calculation.pensionSavingsTaxCharges.PensionSavingsTaxCharges
import v5.retrieveCalculation.def1.model.response.calculation.previousCalculation.PreviousCalculation
import v5.retrieveCalculation.def1.model.response.calculation.reliefs.Reliefs
import v5.retrieveCalculation.def1.model.response.calculation.royaltyPayments.RoyaltyPayments
import v5.retrieveCalculation.def1.model.response.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v5.retrieveCalculation.def1.model.response.calculation.seafarersDeductions.SeafarersDeductions
import v5.retrieveCalculation.def1.model.response.calculation.shareSchemesIncome.ShareSchemesIncome
import v5.retrieveCalculation.def1.model.response.calculation.stateBenefitsIncome.StateBenefitsIncome
import v5.retrieveCalculation.def1.model.response.calculation.studentLoans.StudentLoans
import v5.retrieveCalculation.def1.model.response.calculation.taxCalculation.TaxCalculation
