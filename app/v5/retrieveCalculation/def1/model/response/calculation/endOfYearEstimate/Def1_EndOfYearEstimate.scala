...
case class Def1_EndOfYearEstimate(
                                   incomeSource: Option[Seq[Def1_IncomeSource]],
  ...
  def withoutTotalAllowanceAndDeductions: Def1_EndOfYearEstimate =
...
object Def1_EndOfYearEstimate {
  implicit val format: OFormat[Def1_EndOfYearEstimate] = Json.format
}
