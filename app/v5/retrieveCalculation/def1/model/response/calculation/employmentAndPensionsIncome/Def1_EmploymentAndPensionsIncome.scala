...
case class Def1_EmploymentAndPensionsIncome(totalPayeEmploymentAndLumpSumIncome: Option[BigDecimal],
                                            totalOccupationalPensionIncome: Option[BigDecimal],
                                            totalBenefitsInKind: Option[BigDecimal],
                                            tipsIncome: Option[BigDecimal],
                                            employmentAndPensionsIncomeDetail: Option[Seq[Def1_EmploymentAndPensionsIncomeDetail]]) {
  ...
  def withoutOffPayrollWorker: Def1_EmploymentAndPensionsIncome = {
...
object Def1_EmploymentAndPensionsIncome {

  implicit val format: Format[Def1_EmploymentAndPensionsIncome] = Json.format[Def1_EmploymentAndPensionsIncome]
}
