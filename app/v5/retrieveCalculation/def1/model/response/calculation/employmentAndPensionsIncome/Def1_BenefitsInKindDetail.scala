...
case class Def1_BenefitsInKindDetail(apportionedAccommodation: Option[BigDecimal],
...
object Def1_BenefitsInKindDetail {

  implicit val reads: Reads[Def1_BenefitsInKindDetail] = for {
  ...
  implicit val writes: OWrites[Def1_BenefitsInKindDetail] = (o: Def1_BenefitsInKindDetail) => {
    JsObject(
      Map(
