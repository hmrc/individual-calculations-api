...
package v5.retrieveCalculation.def1.model.response.calculation.studentLoans

import play.api.libs.json.{Json, OFormat}
import v5.retrieveCalculation.def1.model.response.common.Def1_StudentLoanPlanType

case class Def1_StudentLoans(planType: Def1_StudentLoanPlanType,
...
object Def1_StudentLoans {
  implicit val format: OFormat[Def1_StudentLoans] = Json.format[Def1_StudentLoans]
}
