...
case class Def1_GainsWithTaxPaidDetail(`type`: String,
                                       customerReference: Option[String],
                                       gainAmount: Option[BigDecimal],
                                       yearsHeld: Option[BigInt],
                                       yearsHeldSinceLastGain: Option[BigInt])

object Def1_GainsWithTaxPaidDetail {
  implicit val format: Format[Def1_GainsWithTaxPaidDetail] = Json.format[Def1_GainsWithTaxPaidDetail]
}
