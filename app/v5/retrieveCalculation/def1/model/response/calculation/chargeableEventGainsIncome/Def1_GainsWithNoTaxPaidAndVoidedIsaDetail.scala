...
case class Def1_GainsWithNoTaxPaidAndVoidedIsaDetail(`type`: String,
...
object Def1_GainsWithNoTaxPaidAndVoidedIsaDetail {
  implicit val format: Format[Def1_GainsWithNoTaxPaidAndVoidedIsaDetail] = Json.format[Def1_GainsWithNoTaxPaidAndVoidedIsaDetail]
}
