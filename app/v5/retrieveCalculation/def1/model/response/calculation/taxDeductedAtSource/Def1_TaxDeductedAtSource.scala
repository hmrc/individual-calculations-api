...
package v5.retrieveCalculation.def1.model.response.calculation.taxDeductedAtSource

import play.api.libs.json.{Json, OFormat}

case class Def1_TaxDeductedAtSource(bbsi: Option[BigDecimal],
  ...
  def withoutTaxTakenOffTradingIncome: Def1_TaxDeductedAtSource =
    copy(taxTakenOffTradingIncome = None)

}

object Def1_TaxDeductedAtSource {
  implicit val format: OFormat[Def1_TaxDeductedAtSource] = Json.format[Def1_TaxDeductedAtSource]
}
