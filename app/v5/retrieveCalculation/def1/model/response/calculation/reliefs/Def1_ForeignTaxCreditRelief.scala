...
case class Def1_ForeignTaxCreditRelief(customerCalculatedRelief: Option[Boolean],
                                       ...
                                       foreignTaxCreditReliefDetail: Option[Seq[Def1_ForeignTaxCreditReliefDetail]])

object Def1_ForeignTaxCreditRelief {
  implicit val format: OFormat[Def1_ForeignTaxCreditRelief] = Json.format[Def1_ForeignTaxCreditRelief]
}
