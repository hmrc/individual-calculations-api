...
case class Def1_ReliefsClaimedDetail(amountClaimed: Option[BigDecimal],
...
object Def1_ReliefsClaimedDetail {
  implicit val format: OFormat[Def1_ReliefsClaimedDetail] = Json.format[Def1_ReliefsClaimedDetail]
}
