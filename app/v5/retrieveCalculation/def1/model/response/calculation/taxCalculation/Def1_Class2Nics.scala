...
case class Def1_Class2Nics(
  ...
  def withoutUnderLowerProfitThreshold: Def1_Class2Nics = copy(underLowerProfitThreshold = None)
}

object Def1_Class2Nics {
  implicit val format: Format[Def1_Class2Nics] = Json.format
}
