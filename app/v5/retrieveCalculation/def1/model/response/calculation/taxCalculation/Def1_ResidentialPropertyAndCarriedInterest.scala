...
case class Def1_ResidentialPropertyAndCarriedInterest(
    ...
    cgtTaxBands: Option[Seq[Def1_CgtBand]],
    totalTaxAmount: Option[BigDecimal]
)

object Def1_ResidentialPropertyAndCarriedInterest {
  implicit val format: Format[Def1_ResidentialPropertyAndCarriedInterest] = Json.format
}
