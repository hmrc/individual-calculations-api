...
case class Def1_IncomeTax(
                           totalIncomeReceivedFromAllSources: BigInt,
                           totalAllowancesAndDeductions: BigInt,
                           totalTaxableIncome: BigInt,
                           payPensionsProfit: Option[Def1_IncomeTaxItem],
                           savingsAndGains: Option[Def1_IncomeTaxItem],
                           dividends: Option[Def1_IncomeTaxItem],
                           lumpSums: Option[Def1_IncomeTaxItem],
                           gainsOnLifePolicies: Option[Def1_IncomeTaxItem],
  ...
  def withoutGiftAidTaxChargeWhereBasicRateDiffers: Def1_IncomeTax = copy(giftAidTaxChargeWhereBasicRateDiffers = None)
}

object Def1_IncomeTax {
  implicit val format: Format[Def1_IncomeTax] = Json.format
}
