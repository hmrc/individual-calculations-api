...
case class Def1_Nics(
    class2Nics: Option[Def1_Class2Nics],
    class4Nics: Option[Def1_Class4Nics],
  ...
  def withoutUnderLowerProfitThreshold: Def1_Nics =
    copy(class2Nics = class2Nics.map(_.withoutUnderLowerProfitThreshold))

}

object Def1_Nics {
  implicit val format: Format[Def1_Nics] = Json.format
}
