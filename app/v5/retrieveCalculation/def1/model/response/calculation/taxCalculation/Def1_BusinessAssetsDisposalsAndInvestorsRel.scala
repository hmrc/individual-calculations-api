...
case class Def1_BusinessAssetsDisposalsAndInvestorsRel(
...
object Def1_BusinessAssetsDisposalsAndInvestorsRel {
  implicit val format: Format[Def1_BusinessAssetsDisposalsAndInvestorsRel] = Json.format
}
