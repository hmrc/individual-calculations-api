...
case class Def1_DefaultCarriedForwardLoss(
...
object Def1_DefaultCarriedForwardLoss {
  ...
  implicit val format: OFormat[Def1_DefaultCarriedForwardLoss] = Json.format[Def1_DefaultCarriedForwardLoss]
