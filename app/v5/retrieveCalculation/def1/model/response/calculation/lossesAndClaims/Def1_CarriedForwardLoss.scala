...
case class Def1_CarriedForwardLoss(
...
object Def1_CarriedForwardLoss {
  ...
  implicit val format: OFormat[Def1_CarriedForwardLoss] = Json.format[Def1_CarriedForwardLoss]
}
