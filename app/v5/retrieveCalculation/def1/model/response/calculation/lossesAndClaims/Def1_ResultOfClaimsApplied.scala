...
case class Def1_ResultOfClaimsApplied(
...
object Def1_ResultOfClaimsApplied {
  ...
  implicit val format: OFormat[Def1_ResultOfClaimsApplied] = Json.format[Def1_ResultOfClaimsApplied]
}
