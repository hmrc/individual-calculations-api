...
package v5.retrieveCalculation.def1.model.response.calculation.previousCalculation

import play.api.libs.json.{Json, OFormat}

case class Def1_PreviousCalculation(
...
object Def1_PreviousCalculation {
  implicit val format: OFormat[Def1_PreviousCalculation] = Json.format
}
