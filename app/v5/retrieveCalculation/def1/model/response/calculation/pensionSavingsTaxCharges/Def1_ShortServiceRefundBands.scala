...
case class Def1_ShortServiceRefundBands(name: String,
                                        rate: BigDecimal,
                                        bandLimit: BigInt,
...
object Def1_ShortServiceRefundBands {
  implicit val format: OFormat[Def1_ShortServiceRefundBands] = Json.format[Def1_ShortServiceRefundBands]
}
