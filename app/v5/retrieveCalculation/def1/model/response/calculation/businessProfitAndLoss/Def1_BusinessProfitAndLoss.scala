...
package v5.retrieveCalculation.def1.model.response.calculation.businessProfitAndLoss
...
case class Def1_BusinessProfitAndLoss(incomeSourceId: String,
...
object Def1_BusinessProfitAndLoss {
  ...
  implicit val reads: Reads[Def1_BusinessProfitAndLoss] = for {
    incomeSourceId                                 <- (JsPath \ "incomeSourceId").read[String]
    incomeSourceType                               <- (JsPath \ "incomeSourceType").read[Def1_IncomeSourceType]
  ...
  implicit val writes: OWrites[Def1_BusinessProfitAndLoss] = (o: Def1_BusinessProfitAndLoss) => {
    JsObject(
      Map(
