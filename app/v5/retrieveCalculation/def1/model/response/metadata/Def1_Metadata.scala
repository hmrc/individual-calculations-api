...
case class Def1_Metadata(calculationId: String,
                         taxYear: TaxYear,
                         requestedBy: String,
                         requestedTimestamp: Option[String],
                         calculationReason: String,
                         calculationTimestamp: Option[String],
                         calculationType: Def1_CalculationType,
...
object Def1_Metadata {

  implicit val taxYearFormat: Format[TaxYear] = TaxYear.downstreamIntToMtdFormat

  implicit val writes: OWrites[Def1_Metadata] = Json.writes[Def1_Metadata]

  implicit val reads: Reads[Def1_Metadata] = (
    (JsPath \ "calculationId").read[String] and
      ...
      (JsPath \ "calculationType").read[Def1_CalculationType] and
