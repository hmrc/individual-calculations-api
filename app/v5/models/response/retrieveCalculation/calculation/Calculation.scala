...
package v5.models.response.retrieveCalculation.calculation

import play.api.libs.json._
import v5.models.response.retrieveCalculation.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v5.models.response.retrieveCalculation.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v5.models.response.retrieveCalculation.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v5.models.response.retrieveCalculation.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v5.models.response.retrieveCalculation.calculation.dividendsIncome.DividendsIncome
import v5.models.response.retrieveCalculation.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v5.models.response.retrieveCalculation.calculation.employmentExpenses.EmploymentExpenses
import v5.models.response.retrieveCalculation.calculation.endOfYearEstimate.EndOfYearEstimate
import v5.models.response.retrieveCalculation.calculation.foreignIncome.ForeignIncome
import v5.models.response.retrieveCalculation.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v5.models.response.retrieveCalculation.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v5.models.response.retrieveCalculation.calculation.giftAid.GiftAid
import v5.models.response.retrieveCalculation.calculation.incomeSummaryTotals.IncomeSummaryTotals
import v5.models.response.retrieveCalculation.calculation.lossesAndClaims.LossesAndClaims
import v5.models.response.retrieveCalculation.calculation.marriageAllowanceTransferredIn.MarriageAllowanceTransferredIn
import v5.models.response.retrieveCalculation.calculation.notionalTax.NotionalTax
import v5.models.response.retrieveCalculation.calculation.otherIncome.OtherIncome
import v5.models.response.retrieveCalculation.calculation.pensionContributionReliefs.PensionContributionReliefs
import v5.models.response.retrieveCalculation.calculation.pensionSavingsTaxCharges.PensionSavingsTaxCharges
import v5.models.response.retrieveCalculation.calculation.previousCalculation.PreviousCalculation
import v5.models.response.retrieveCalculation.calculation.reliefs.Reliefs
import v5.models.response.retrieveCalculation.calculation.royaltyPayments.RoyaltyPayments
import v5.models.response.retrieveCalculation.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v5.models.response.retrieveCalculation.calculation.seafarersDeductions.SeafarersDeductions
import v5.models.response.retrieveCalculation.calculation.shareSchemesIncome.ShareSchemesIncome
import v5.models.response.retrieveCalculation.calculation.stateBenefitsIncome.StateBenefitsIncome
import v5.models.response.retrieveCalculation.calculation.studentLoans.StudentLoans
import v5.models.response.retrieveCalculation.calculation.taxCalculation.TaxCalculation
