...
package v5.models.response.retrieveCalculation.calculation.businessProfitAndLoss

import play.api.libs.json._
import v5.models.response.common.IncomeSourceType
import v5.models.response.common.IncomeSourceType.{`foreign-property-fhl-eea`, `foreign-property`, `self-employment`, `uk-property-fhl`, `uk-property-non-fhl`}
