...
package v8.retrieveCalculation.def2.model.response.calculation

import play.api.libs.json._
import v8.retrieveCalculation.def2.model.response.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v8.retrieveCalculation.def2.model.response.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v8.retrieveCalculation.def2.model.response.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v8.retrieveCalculation.def2.model.response.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v8.retrieveCalculation.def2.model.response.calculation.dividendsIncome.DividendsIncome
import v8.retrieveCalculation.def2.model.response.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v8.retrieveCalculation.def2.model.response.calculation.employmentExpenses.EmploymentExpenses
import v8.retrieveCalculation.def2.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v8.retrieveCalculation.def2.model.response.calculation.foreignIncome.ForeignIncome
import v8.retrieveCalculation.def2.model.response.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v8.retrieveCalculation.def2.model.response.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v8.retrieveCalculation.def2.model.response.calculation.giftAid.GiftAid
import v8.retrieveCalculation.def2.model.response.calculation.incomeSummaryTotals.IncomeSummaryTotals
import v8.retrieveCalculation.def2.model.response.calculation.lossesAndClaims.LossesAndClaims
import v8.retrieveCalculation.def2.model.response.calculation.marriageAllowanceTransferredIn.MarriageAllowanceTransferredIn
import v8.retrieveCalculation.def2.model.response.calculation.notionalTax.NotionalTax
import v8.retrieveCalculation.def2.model.response.calculation.otherIncome.OtherIncome
import v8.retrieveCalculation.def2.model.response.calculation.pensionContributionReliefs.PensionContributionReliefs
import v8.retrieveCalculation.def2.model.response.calculation.pensionSavingsTaxCharges.PensionSavingsTaxCharges
import v8.retrieveCalculation.def2.model.response.calculation.previousCalculation.PreviousCalculation
import v8.retrieveCalculation.def2.model.response.calculation.reliefs.Reliefs
import v8.retrieveCalculation.def2.model.response.calculation.royaltyPayments.RoyaltyPayments
import v8.retrieveCalculation.def2.model.response.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v8.retrieveCalculation.def2.model.response.calculation.seafarersDeductions.SeafarersDeductions
import v8.retrieveCalculation.def2.model.response.calculation.shareSchemesIncome.ShareSchemesIncome
import v8.retrieveCalculation.def2.model.response.calculation.stateBenefitsIncome.StateBenefitsIncome
import v8.retrieveCalculation.def2.model.response.calculation.studentLoans.StudentLoans
import v8.retrieveCalculation.def2.model.response.calculation.taxCalculation.TaxCalculation
import v8.retrieveCalculation.def2.model.response.calculation.taxDeductedAtSource.TaxDeductedAtSource
import v8.retrieveCalculation.def2.model.response.calculation.transitionProfit.TransitionProfit
