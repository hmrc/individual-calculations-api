...
import v8.retrieveCalculation.def4.model.response.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v8.retrieveCalculation.def4.model.response.calculation.dividendsIncome.DividendsIncome
import v8.retrieveCalculation.def4.model.response.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v8.retrieveCalculation.def4.model.response.calculation.employmentExpenses.EmploymentExpenses
import v8.retrieveCalculation.def4.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v8.retrieveCalculation.def4.model.response.calculation.foreignIncome.ForeignIncome
import v8.retrieveCalculation.def4.model.response.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v8.retrieveCalculation.def4.model.response.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
...
import v8.retrieveCalculation.def4.model.response.calculation.reliefs.Reliefs
import v8.retrieveCalculation.def4.model.response.calculation.royaltyPayments.RoyaltyPayments
import v8.retrieveCalculation.def4.model.response.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v8.retrieveCalculation.def4.model.response.calculation.seafarersDeductions.SeafarersDeductions
import v8.retrieveCalculation.def4.model.response.calculation.shareSchemesIncome.ShareSchemesIncome
import v8.retrieveCalculation.def4.model.response.calculation.stateBenefitsIncome.StateBenefitsIncome
import v8.retrieveCalculation.def4.model.response.calculation.studentLoans.StudentLoans
