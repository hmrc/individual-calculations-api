...
import v4.controllers.EndpointLogContext
import v4.models.errors.{DownstreamError, ErrorWrapper}
import v4.models.response.common.DownstreamResponse
...
trait BaseConnector extends Logging {
  ...
  def downstreamPost[Body: Writes, Resp <: DownstreamResponse](body: Body, uri: Uri[Resp])(implicit
      ec: ExecutionContext,
      hc: HeaderCarrier,
