...
package v4.models.response.retrieveCalculation.calculation

import play.api.libs.json._
import v4.models.response.retrieveCalculation.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v4.models.response.retrieveCalculation.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v4.models.response.retrieveCalculation.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v4.models.response.retrieveCalculation.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v4.models.response.retrieveCalculation.calculation.dividendsIncome.DividendsIncome
import v4.models.response.retrieveCalculation.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v4.models.response.retrieveCalculation.calculation.employmentExpenses.EmploymentExpenses
import v4.models.response.retrieveCalculation.calculation.endOfYearEstimate.EndOfYearEstimate
import v4.models.response.retrieveCalculation.calculation.foreignIncome.ForeignIncome
import v4.models.response.retrieveCalculation.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v4.models.response.retrieveCalculation.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v4.models.response.retrieveCalculation.calculation.giftAid.GiftAid
import v4.models.response.retrieveCalculation.calculation.incomeSummaryTotals.IncomeSummaryTotals
...
import v4.models.response.retrieveCalculation.calculation.reliefs.Reliefs
import v4.models.response.retrieveCalculation.calculation.royaltyPayments.RoyaltyPayments
import v4.models.response.retrieveCalculation.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v4.models.response.retrieveCalculation.calculation.seafarersDeductions.SeafarersDeductions
import v4.models.response.retrieveCalculation.calculation.shareSchemesIncome.ShareSchemesIncome
import v4.models.response.retrieveCalculation.calculation.stateBenefitsIncome.StateBenefitsIncome
import v4.models.response.retrieveCalculation.calculation.studentLoans.StudentLoans
import v4.models.response.retrieveCalculation.calculation.taxCalculation.TaxCalculation
