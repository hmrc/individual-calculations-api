...
package v4.models.response.retrieveCalculation.calculation.savingsAndGainsIncome

import play.api.libs.json.{Format, Json}
import v4.models.response.common.IncomeSourceType
import v4.models.response.common.IncomeSourceType.{`uk-savings-and-gains`, `uk-securities`}
