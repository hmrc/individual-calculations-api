...
package v2.models.response.getTaxableIncome.detail.selfEmployment

import play.api.libs.json._
import v2.models.response.getTaxableIncome.detail.selfEmployment.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v2.models.response.getTaxableIncome.detail.selfEmployment.summary.LossClaimsSummary
