...
package v7.retrieveCalculation.def3.model.response.calculation

import play.api.libs.json._
import v7.retrieveCalculation.def3.model.response.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v7.retrieveCalculation.def3.model.response.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v7.retrieveCalculation.def3.model.response.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v7.retrieveCalculation.def3.model.response.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v7.retrieveCalculation.def3.model.response.calculation.dividendsIncome.DividendsIncome
import v7.retrieveCalculation.def3.model.response.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v7.retrieveCalculation.def3.model.response.calculation.employmentExpenses.EmploymentExpenses
import v7.retrieveCalculation.def3.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v7.retrieveCalculation.def3.model.response.calculation.foreignIncome.ForeignIncome
import v7.retrieveCalculation.def3.model.response.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v7.retrieveCalculation.def3.model.response.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v7.retrieveCalculation.def3.model.response.calculation.giftAid.GiftAid
import v7.retrieveCalculation.def3.model.response.calculation.highIncomeChildBenefitCharge.HighIncomeChildBenefitCharge
import v7.retrieveCalculation.def3.model.response.calculation.incomeSummaryTotals.IncomeSummaryTotals
import v7.retrieveCalculation.def3.model.response.calculation.lossesAndClaims.LossesAndClaims
import v7.retrieveCalculation.def3.model.response.calculation.marriageAllowanceTransferredIn.MarriageAllowanceTransferredIn
import v7.retrieveCalculation.def3.model.response.calculation.notionalTax.NotionalTax
import v7.retrieveCalculation.def3.model.response.calculation.otherIncome.OtherIncome
import v7.retrieveCalculation.def3.model.response.calculation.pensionContributionReliefs.PensionContributionReliefs
import v7.retrieveCalculation.def3.model.response.calculation.pensionSavingsTaxCharges.PensionSavingsTaxCharges
import v7.retrieveCalculation.def3.model.response.calculation.previousCalculation.PreviousCalculation
import v7.retrieveCalculation.def3.model.response.calculation.reliefs.Reliefs
import v7.retrieveCalculation.def3.model.response.calculation.royaltyPayments.RoyaltyPayments
import v7.retrieveCalculation.def3.model.response.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v7.retrieveCalculation.def3.model.response.calculation.seafarersDeductions.SeafarersDeductions
import v7.retrieveCalculation.def3.model.response.calculation.shareSchemesIncome.ShareSchemesIncome
import v7.retrieveCalculation.def3.model.response.calculation.stateBenefitsIncome.StateBenefitsIncome
import v7.retrieveCalculation.def3.model.response.calculation.studentLoans.StudentLoans
import v7.retrieveCalculation.def3.model.response.calculation.taxCalculation.TaxCalculation
import v7.retrieveCalculation.def3.model.response.calculation.taxDeductedAtSource.TaxDeductedAtSource
