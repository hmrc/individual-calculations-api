...
//object Calculation {
//
//  implicit val writes: OWrites[Calculation] = OWrites.apply[Calculation] { case a: Def2_Calculation =>
//    Json.toJsObject(a)
//  }
//
//}
...
object Def2_Calculation {
  ...
  implicit val reads: Reads[Def2_Calculation] =
    ((JsPath \ "calculationId").read[String] and
      ...
      (JsPath \ "liabilityAmount").read[BigDecimal])(Def2_Calculation.apply _)
