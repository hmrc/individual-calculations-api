...
package v9.retrieveCalculation.def1.model.response.calculation

import play.api.libs.json.*
import v9.retrieveCalculation.def1.model.response.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v9.retrieveCalculation.def1.model.response.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v9.retrieveCalculation.def1.model.response.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v9.retrieveCalculation.def1.model.response.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v9.retrieveCalculation.def1.model.response.calculation.dividendsIncome.DividendsIncome
import v9.retrieveCalculation.def1.model.response.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v9.retrieveCalculation.def1.model.response.calculation.employmentExpenses.EmploymentExpenses
import v9.retrieveCalculation.def1.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v9.retrieveCalculation.def1.model.response.calculation.foreignIncome.ForeignIncome
import v9.retrieveCalculation.def1.model.response.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v9.retrieveCalculation.def1.model.response.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v9.retrieveCalculation.def1.model.response.calculation.giftAid.GiftAid
import v9.retrieveCalculation.def1.model.response.calculation.incomeSummaryTotals.IncomeSummaryTotals
import v9.retrieveCalculation.def1.model.response.calculation.lossesAndClaims.LossesAndClaims
import v9.retrieveCalculation.def1.model.response.calculation.marriageAllowanceTransferredIn.MarriageAllowanceTransferredIn
import v9.retrieveCalculation.def1.model.response.calculation.notionalTax.NotionalTax
import v9.retrieveCalculation.def1.model.response.calculation.otherIncome.OtherIncome
import v9.retrieveCalculation.def1.model.response.calculation.pensionContributionReliefs.PensionContributionReliefs
import v9.retrieveCalculation.def1.model.response.calculation.pensionSavingsTaxCharges.PensionSavingsTaxCharges
import v9.retrieveCalculation.def1.model.response.calculation.previousCalculation.PreviousCalculation
import v9.retrieveCalculation.def1.model.response.calculation.reliefs.Reliefs
import v9.retrieveCalculation.def1.model.response.calculation.royaltyPayments.RoyaltyPayments
import v9.retrieveCalculation.def1.model.response.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v9.retrieveCalculation.def1.model.response.calculation.seafarersDeductions.SeafarersDeductions
import v9.retrieveCalculation.def1.model.response.calculation.shareSchemesIncome.ShareSchemesIncome
import v9.retrieveCalculation.def1.model.response.calculation.stateBenefitsIncome.StateBenefitsIncome
import v9.retrieveCalculation.def1.model.response.calculation.studentLoans.StudentLoans
import v9.retrieveCalculation.def1.model.response.calculation.taxCalculation.TaxCalculation
import v9.retrieveCalculation.def1.model.response.calculation.taxDeductedAtSource.TaxDeductedAtSource
