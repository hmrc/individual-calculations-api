...
package v1r2.models.response.getTaxableIncome.detail.ukPropertyFhl

import play.api.libs.json._
import v1r2.models.response.getTaxableIncome.detail.ukPropertyFhl.detail.{LossClaimsDetail, BusinessSourceAdjustableSummary}
import v1r2.models.response.getTaxableIncome.detail.ukPropertyFhl.summary.LossClaimsSummary
