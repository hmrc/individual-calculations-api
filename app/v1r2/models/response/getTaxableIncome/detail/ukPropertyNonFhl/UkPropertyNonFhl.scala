...
package v1r2.models.response.getTaxableIncome.detail.ukPropertyNonFhl

import play.api.libs.json._
import v1r2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v1r2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.summary.LossClaimsSummary
