...
package v1r2.models.response.getTaxableIncome.detail.selfEmployment

import play.api.libs.json._
import v1r2.models.response.getTaxableIncome.detail.selfEmployment.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v1r2.models.response.getTaxableIncome.detail.selfEmployment.summary.LossClaimsSummary
