...
import v1.models.response.getTaxableIncome.detail.ukPropertyNonFhl.detail.{ClaimNotApplied, DefaultCarriedForwardLoss, LossBroughtForward, ResultOfClaimApplied}
