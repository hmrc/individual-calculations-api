...
package v1.models.response.getTaxableIncome.detail.businessProfitAndLoss

import play.api.libs.json._
import utils.NestedJsonReads
import v1.models.response.getTaxableIncome.detail.businessProfitAndLoss.ukPropertyNonFhl.{LossClaimsDetail, LossClaimsSummary}
