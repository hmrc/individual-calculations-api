...
package v1.models.response.getTaxableIncome.detail.businessProfitAndLoss.ukPropertyNonFhl

import play.api.libs.json._
import utils.NestedJsonReads
import v1.models.response.getTaxableIncome.detail.businessProfitAndLoss.ukPropertyNonFhl.detail.{ClaimNotApplied, DefaultCarriedForwardLoss, LossBroughtForward, ResultOfClaimApplied}
