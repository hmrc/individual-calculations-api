...
package v1.models.response.taxableIncome.detail.ukPropertyNonFhl

import play.api.libs.json._
import utils.NestedJsonReads
import v1.models.response.taxableIncome.detail.ukPropertyNonFhl.detail.LossClaimsDetail
