...
package v6.retrieveCalculation.def1.model.response.calculation.pensionSavingsTaxCharges

import play.api.libs.json.{Json, OFormat}
import v6.retrieveCalculation.def1.model.response.common.TaxRate
