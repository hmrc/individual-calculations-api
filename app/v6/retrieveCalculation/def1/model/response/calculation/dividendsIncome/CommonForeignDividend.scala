...
package v6.retrieveCalculation.def1.model.response.calculation.dividendsIncome

import play.api.libs.json.{Format, Json}
import v6.retrieveCalculation.def1.model.response.common.IncomeSourceType
import v6.retrieveCalculation.def1.model.response.common.IncomeSourceType.`foreign-dividends`
