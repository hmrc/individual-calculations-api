...
package v6.retrieveCalculation.def2.model.response.calculation

import play.api.libs.json._
import v6.retrieveCalculation.def2.model.response.calculation.allowancesAndDeductions.AllowancesAndDeductions
import v6.retrieveCalculation.def2.model.response.calculation.businessProfitAndLoss.BusinessProfitAndLoss
import v6.retrieveCalculation.def2.model.response.calculation.chargeableEventGainsIncome.ChargeableEventGainsIncome
import v6.retrieveCalculation.def2.model.response.calculation.codedOutUnderpayments.CodedOutUnderpayments
import v6.retrieveCalculation.def2.model.response.calculation.dividendsIncome.DividendsIncome
import v6.retrieveCalculation.def2.model.response.calculation.employmentAndPensionsIncome.EmploymentAndPensionsIncome
import v6.retrieveCalculation.def2.model.response.calculation.employmentExpenses.EmploymentExpenses
import v6.retrieveCalculation.def2.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v6.retrieveCalculation.def2.model.response.calculation.foreignIncome.ForeignIncome
import v6.retrieveCalculation.def2.model.response.calculation.foreignPropertyIncome.ForeignPropertyIncome
import v6.retrieveCalculation.def2.model.response.calculation.foreignTaxForFtcrNotClaimed.ForeignTaxForFtcrNotClaimed
import v6.retrieveCalculation.def2.model.response.calculation.giftAid.GiftAid
import v6.retrieveCalculation.def2.model.response.calculation.incomeSummaryTotals.IncomeSummaryTotals
import v6.retrieveCalculation.def2.model.response.calculation.lossesAndClaims.LossesAndClaims
import v6.retrieveCalculation.def2.model.response.calculation.marriageAllowanceTransferredIn.MarriageAllowanceTransferredIn
import v6.retrieveCalculation.def2.model.response.calculation.notionalTax.NotionalTax
import v6.retrieveCalculation.def2.model.response.calculation.otherIncome.OtherIncome
import v6.retrieveCalculation.def2.model.response.calculation.pensionContributionReliefs.PensionContributionReliefs
import v6.retrieveCalculation.def2.model.response.calculation.pensionSavingsTaxCharges.PensionSavingsTaxCharges
import v6.retrieveCalculation.def2.model.response.calculation.previousCalculation.PreviousCalculation
import v6.retrieveCalculation.def2.model.response.calculation.reliefs.Reliefs
import v6.retrieveCalculation.def2.model.response.calculation.royaltyPayments.RoyaltyPayments
import v6.retrieveCalculation.def2.model.response.calculation.savingsAndGainsIncome.SavingsAndGainsIncome
import v6.retrieveCalculation.def2.model.response.calculation.seafarersDeductions.SeafarersDeductions
import v6.retrieveCalculation.def2.model.response.calculation.shareSchemesIncome.ShareSchemesIncome
import v6.retrieveCalculation.def2.model.response.calculation.stateBenefitsIncome.StateBenefitsIncome
import v6.retrieveCalculation.def2.model.response.calculation.studentLoans.StudentLoans
import v6.retrieveCalculation.def2.model.response.calculation.taxCalculation.TaxCalculation
import v6.retrieveCalculation.def2.model.response.calculation.taxDeductedAtSource.TaxDeductedAtSource
import v6.retrieveCalculation.def2.model.response.calculation.transitionProfit.TransitionProfit
