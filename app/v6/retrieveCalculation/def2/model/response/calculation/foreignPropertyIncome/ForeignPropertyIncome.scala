...
package v6.retrieveCalculation.def2.model.response.calculation.foreignPropertyIncome

import play.api.libs.json.{Format, Json, OFormat}
import v6.retrieveCalculation.def2.model.response.common.IncomeSourceType
import v6.retrieveCalculation.def2.model.response.common.IncomeSourceType.`foreign-property`
