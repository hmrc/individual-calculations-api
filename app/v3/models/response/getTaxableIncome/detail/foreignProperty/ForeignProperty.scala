...
package v3.models.response.getTaxableIncome.detail.foreignProperty

import play.api.libs.json.{Json, OFormat}
import v3.models.response.getTaxableIncome.detail.foreignProperty.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v3.models.response.getTaxableIncome.detail.foreignProperty.summary.LossClaimsSummary
