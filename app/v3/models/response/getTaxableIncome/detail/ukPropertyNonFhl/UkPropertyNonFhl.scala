...
package v3.models.response.getTaxableIncome.detail.ukPropertyNonFhl

import play.api.libs.json._
import v3.models.response.getTaxableIncome.detail.ukPropertyNonFhl.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v3.models.response.getTaxableIncome.detail.ukPropertyNonFhl.summary.LossClaimsSummary
