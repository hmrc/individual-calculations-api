...
package v3.models.response.getTaxableIncome.detail.ukPropertyFhl

import play.api.libs.json._
import v3.models.response.getTaxableIncome.detail.ukPropertyFhl.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v3.models.response.getTaxableIncome.detail.ukPropertyFhl.summary.LossClaimsSummary
