...
package v3.models.response.getTaxableIncome.detail.eeaPropertyFhl

import play.api.libs.json._
import v3.models.response.getTaxableIncome.detail.eeaPropertyFhl.detail.{BusinessSourceAdjustableSummary, LossClaimsDetail}
import v3.models.response.getTaxableIncome.detail.eeaPropertyFhl.summary.LossClaimsSummary
