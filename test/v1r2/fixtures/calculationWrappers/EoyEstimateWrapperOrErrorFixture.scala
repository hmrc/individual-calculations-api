...
package v1r2.fixtures.calculationWrappers

import play.api.libs.json.{JsValue, Json}
import v1r2.fixtures.getEndOfYearEstimate.EoyEstimateResponseFixture.{eoyEstimateResponseJson, eoyEstimateResponseModel}
