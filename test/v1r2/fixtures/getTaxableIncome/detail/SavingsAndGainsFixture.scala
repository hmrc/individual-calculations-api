...
import v1r2.fixtures.getTaxableIncome.detail.SavingsFixture._
import v1r2.fixtures.getTaxableIncome.detail.UkSecuritiesFixture._
import v1r2.models.response.getTaxableIncome.detail.SavingsAndGains
