...
package v1r2.fixtures.getTaxableIncome.detail.selfEmployment

import play.api.libs.json.{JsValue, Json}
import v1r2.fixtures.getTaxableIncome.detail.selfEmployment.detail.LossClaimsDetailFixture._
import v1r2.fixtures.getTaxableIncome.detail.selfEmployment.summary.LossClaimSummaryFixture._
import v1r2.models.response.getTaxableIncome.detail.selfEmployment.SelfEmployment
import v1r2.models.response.getTaxableIncome.detail.selfEmployment.detail.BusinessSourceAdjustableSummary
