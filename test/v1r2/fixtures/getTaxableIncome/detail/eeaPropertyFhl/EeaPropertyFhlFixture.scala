...
package v1r2.fixtures.getTaxableIncome.detail.eeaPropertyFhl

import play.api.libs.json.{JsValue, Json}
import v1r2.fixtures.getTaxableIncome.detail.eeaPropertyFhl.detail.LossClaimsDetailFixture.{lossClaimsDetailJson, lossClaimsDetailModel}
import v1r2.fixtures.getTaxableIncome.detail.eeaPropertyFhl.summary.LossClaimSummaryFixture.{lossClaimSummaryJson, lossClaimsSummaryModel}
import v1r2.models.response.getTaxableIncome.detail.eeaPropertyFhl.EeaPropertyFhl
import v1r2.models.response.getTaxableIncome.detail.eeaPropertyFhl.detail.BusinessSourceAdjustableSummary
