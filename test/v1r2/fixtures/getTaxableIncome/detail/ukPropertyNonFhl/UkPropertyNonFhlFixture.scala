...
package v1r2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl

import play.api.libs.json.{JsValue, Json}
import v1r2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail.LossClaimsDetailFixture._
import v1r2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.summary.LossClaimsSummaryFixture._
import v1r2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.UkPropertyNonFhl
import v1r2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.detail.BusinessSourceAdjustableSummary
