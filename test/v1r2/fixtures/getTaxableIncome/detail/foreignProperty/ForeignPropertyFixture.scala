...
package v1r2.fixtures.getTaxableIncome.detail.foreignProperty

import play.api.libs.json.{JsValue, Json}
import v1r2.fixtures.getTaxableIncome.detail.foreignProperty.detail.LossClaimsDetailFixture._
import v1r2.fixtures.getTaxableIncome.detail.foreignProperty.summary.LossClaimSummaryFixture._
import v1r2.models.response.getTaxableIncome.detail.foreignProperty.ForeignProperty
import v1r2.models.response.getTaxableIncome.detail.foreignProperty.detail.BusinessSourceAdjustableSummary
