...
package v1r2.fixtures.getIncomeTaxAndNics.summary

import play.api.libs.json.{JsValue, Json}
import v1r2.fixtures.getIncomeTaxAndNics.summary.IncomeTaxSummaryFixture._
import v1r2.fixtures.getIncomeTaxAndNics.summary.NicSummaryFixture._
import v1r2.models.response.getIncomeTaxAndNics.summary.CalculationSummary
