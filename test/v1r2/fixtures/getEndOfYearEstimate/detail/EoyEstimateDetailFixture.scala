...
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateForeignInterestFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateForeignPropertyFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateOtherDividendsFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateSelfEmploymentsFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateStateBenefitsFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateUkDividendsFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateUkPropertyFhlFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateUkPropertyNonFhlFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateUkSavingsFixture._
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateUkSecuritiesFixture._
import v1r2.models.response.getEoyEstimate.detail.EoyEstimateDetail
