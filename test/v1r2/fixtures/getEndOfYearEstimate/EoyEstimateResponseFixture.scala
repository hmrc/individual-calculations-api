...
package v1r2.fixtures.getEndOfYearEstimate

import play.api.libs.json.{JsObject, JsValue, Json}
import v1r2.fixtures.getEndOfYearEstimate.detail.EoyEstimateDetailFixture._
import v1r2.fixtures.getEndOfYearEstimate.summary.EoyEstimateSummaryFixture._
import v1r2.fixtures.getMetadata.MetadataResponseFixture._
import v1r2.models.response.getEoyEstimate.EoyEstimateResponse
