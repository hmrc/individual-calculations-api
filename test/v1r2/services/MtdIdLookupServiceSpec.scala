...
import v1r2.mocks.connectors.MockMtdIdLookupConnector
import v1r2.models.errors.{DownstreamError, NinoFormatError, UnauthorisedError}
  ...
  "calling .getMtdId" when {
    ...
    "a not authorised error occurs the service" should {
      "proxy the error to the caller" in new Test {
        ...
        MockedMtdIdLookupConnector.lookup(nino.nino)
