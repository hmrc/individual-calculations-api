...
import v1r2.models.hateoas.Method.{GET, POST}
import v1r2.models.outcomes.ResponseWrapper
import v1r2.models.request.{ListCalculationsRawData, ListCalculationsRequest}
import v1r2.models.response.common.{CalculationRequestor, CalculationType}
import v1r2.models.response.listCalculations.{CalculationListItem, ListCalculationsHateoasData, ListCalculationsResponse}
