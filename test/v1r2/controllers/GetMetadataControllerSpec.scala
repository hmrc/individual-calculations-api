...
import v1r2.models.response.common.{CalculationReason, CalculationRequestor, CalculationType}
import v1r2.models.response.getMetadata.{MetadataExistence, MetadataHateoasData, MetadataResponse}
