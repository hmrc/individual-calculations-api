...
import v1r2.fixtures.getEndOfYearEstimate.EoyEstimateResponseFixture
import v1r2.handler.RequestDefn
import v1r2.mocks.hateoas.MockHateoasFactory
import v1r2.mocks.requestParsers.MockGetCalculationParser
import v1r2.mocks.services.{MockAuditService, MockEnrolmentsAuthService, MockMtdIdLookupService, MockStandardService}
import v1r2.models.audit.{AuditError, AuditEvent, AuditResponse, GenericAuditDetail}
import v1r2.models.errors.{EndOfYearEstimateNotPresentError, RuleCalculationErrorMessagesExist}
import v1r2.models.hateoas.{HateoasWrapper, Link}
import v1r2.models.hateoas.Method.GET
import v1r2.models.outcomes.ResponseWrapper
import v1r2.models.request.{GetCalculationRawData, GetCalculationRequest}
import v1r2.models.response.calculationWrappers.EoyEstimateWrapperOrError
import v1r2.models.response.calculationWrappers.EoyEstimateWrapperOrError.EoyEstimateWrapper
import v1r2.models.response.getEoyEstimate.EoyEstimateHateoasData
