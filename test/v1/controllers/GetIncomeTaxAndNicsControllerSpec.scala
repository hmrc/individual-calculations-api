  ...
  "handleRequest" should {
    "return OK with the calculation" when {
      "happy path" in new Test {
        ...
        MockStandardService
          .doService(RequestDefinition.Get[CalculationWrapperOrError[GetIncomeTaxAndNicsResponse], GetIncomeTaxAndNicsResponse](uri), OK)
        ...
        contentAsJson(result) shouldBe GetIncomeTaxAndNicsFixture.successOutputToVendor
