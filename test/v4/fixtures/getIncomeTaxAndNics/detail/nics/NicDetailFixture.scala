...
package v4.fixtures.getIncomeTaxAndNics.detail.nics

import play.api.libs.json.{JsValue, Json}
import v4.fixtures.getIncomeTaxAndNics.detail.nics.Class2NicDetailFixture._
import v4.fixtures.getIncomeTaxAndNics.detail.nics.Class4NicDetailFixture._
