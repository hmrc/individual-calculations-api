...
import v4.fixtures.getIncomeTaxAndNics.detail.capitalGainsTax.CgtTaxBandFixture._
import v4.models.response.getIncomeTaxAndNics.detail.capitalGainsTax.{CgtTaxBandName, ResidentialPropertyAndCarriedInterest}
