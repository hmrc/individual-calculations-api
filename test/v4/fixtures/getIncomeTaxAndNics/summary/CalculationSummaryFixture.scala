...
package v4.fixtures.getIncomeTaxAndNics.summary

import play.api.libs.json.{JsValue, Json}
import v4.fixtures.getIncomeTaxAndNics.summary.CapitalGainsTaxSummaryFixture.{capitalGainsTaxSummaryJson, capitalGainsTaxSummaryModel}
import v4.fixtures.getIncomeTaxAndNics.summary.IncomeTaxSummaryFixture._
import v4.fixtures.getIncomeTaxAndNics.summary.NicSummaryFixture._
...
object CalculationSummaryFixture {
  ...
  val calculationSummaryModel: CalculationSummary =
    CalculationSummary(
      ...
      totalIncomeTaxAndNicsDue = Some(totalIncomeTaxAndNicsDue),
      taxRegime = taxRegime,
