...
package v9.retrieveCalculation.def2.model.response

import api.models.utils.JsonErrorValidators
import api.utils.UnitSpec
import org.scalatest.Inside
import play.api.libs.json.Json
import v9.retrieveCalculation.def2.model.Def2_CalculationFixture
import v9.retrieveCalculation.models.response.Def2_RetrieveCalculationResponse
  ...
  "Def2_RetrieveCalculationResponse" must {
    ...
    "return hasErrors is false when messages.errors is empty" in {
      val model = calculationDownstreamJson
        ...
        .as[Def2_RetrieveCalculationResponse]
    ...
    "allow messages to be missing" in {
      ...
      val model = jsonWithoutMessages.as[Def2_RetrieveCalculationResponse]
