...
package v9.retrieveCalculation.def1.model

import api.models.domain.TaxYear
import play.api.libs.json.{JsObject, JsValue, Json}
import v9.common.model.response.IncomeSourceType
import v9.common.model.response.RetrieveCalculationType.`in-year`
import v9.retrieveCalculation.def1.model.response.calculation.Calculation
import v9.retrieveCalculation.def1.model.response.calculation.employmentAndPensionsIncome.*
import v9.retrieveCalculation.def1.model.response.calculation.endOfYearEstimate.*
import v9.retrieveCalculation.def1.model.response.calculation.otherIncome.*
import v9.retrieveCalculation.def1.model.response.calculation.reliefs.*
import v9.retrieveCalculation.def1.model.response.calculation.taxCalculation.*
import v9.retrieveCalculation.def1.model.response.calculation.taxDeductedAtSource.*
import v9.retrieveCalculation.def1.model.response.inputs.*
import v9.retrieveCalculation.def1.model.response.metadata.*
import v9.retrieveCalculation.def1.model.response.metadata.CalculationReason.*
import v9.retrieveCalculation.models.response.Def1_RetrieveCalculationResponse
...
trait Def1_CalculationFixture {
  ...
  val calculationMtdJson: JsValue =
    Json.parse(getClass.getResourceAsStream("/v9/retrieveCalculation/def1/model/response/calculation_mtd.json"))

  val calculationDownstreamJson: JsObject =
    Json.parse(getClass.getResourceAsStream("/v9/retrieveCalculation/def1/model/response/calculation_downstream.json")).as[JsObject]
