...
package v9.retrieveCalculation.def4.model.response.calculation.foreignPropertyIncome

import api.utils.UnitSpec
import play.api.libs.json.{JsError, JsObject, JsValue, Json}
import v9.common.model.response.IncomeSourceType
import v9.common.model.response.IncomeSourceType.`foreign-property`
      ...
      propertyLevelDetail = Some(
        Seq(
          PropertyLevelDetail(
            propertyId = "8e8b8450-dc1b-4360-8109-7067337b42cb",
            totalIncome = Some(5000.99),
            totalExpenses = Some(-99999999999.99),
            netProfit = Some(5000.99),
            netLoss = Some(5000.99),
            totalAdditions = Some(5000.99),
            totalDeductions = Some(5000.99),
