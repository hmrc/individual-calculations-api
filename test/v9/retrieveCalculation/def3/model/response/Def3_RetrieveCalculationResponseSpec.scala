...
package v9.retrieveCalculation.def3.model.response

import api.models.utils.JsonErrorValidators
import api.utils.UnitSpec
import org.scalatest.Inside
import play.api.libs.json.Json
import v9.retrieveCalculation.def3.model.Def3_CalculationFixture
import v9.retrieveCalculation.models.response.Def3_RetrieveCalculationResponse
  ...
  "Def3_RetrieveCalculationResponse" must {
    ...
    "return hasErrors is false when messages.errors is empty" in {
      val model = calculationDownstreamJson
        ...
        .as[Def3_RetrieveCalculationResponse]
    ...
    "allow messages to be missing" in {
      ...
      val model = jsonWithoutMessages.as[Def3_RetrieveCalculationResponse]
