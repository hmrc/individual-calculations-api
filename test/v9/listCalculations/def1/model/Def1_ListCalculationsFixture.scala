...
package v9.listCalculations.def1.model

import api.models.domain.TaxYear
import play.api.libs.json.{JsValue, Json}
import v9.listCalculations.def1.model.response.Def1_Calculation
import v9.listCalculations.model.response.{Calculation, Def1_ListCalculationsResponse, ListCalculationType, ListCalculationsResponse}
...
trait Def1_ListCalculationsFixture {
  ...
  val calculationModel: Def1_Calculation = Def1_Calculation(
    calculationId = "c432a56d-e811-474c-a26a-76fc3bcaefe5",
    calculationTimestamp = "2021-07-12T07:51:43.112Z",
    calculationType = ListCalculationType.`final-declaration`,
