...
package v9.submitFinalDeclaration
...
import v9.common.model.domain.{CalculationType, `final-declaration`}
import v9.retrieveCalculation.MockRetrieveCalculationService
import v9.retrieveCalculation.def1.model.Def1_CalculationFixture
import v9.retrieveCalculation.models.request.Def1_RetrieveCalculationRequestData
import v9.retrieveCalculation.models.response.Def1_RetrieveCalculationResponse
import v9.submitFinalDeclaration.model.request.{Def1_SubmitFinalDeclarationRequestData, SubmitFinalDeclarationRequestData}
  ...
  "NrsService" when {
    ...
    "updateNrs is called" must {
      "submit full details to NRS when retrieveCalculationDetails succeeds" in new Test {
        ...
        val result: Unit = await(service.updateNrs(nino, request))
