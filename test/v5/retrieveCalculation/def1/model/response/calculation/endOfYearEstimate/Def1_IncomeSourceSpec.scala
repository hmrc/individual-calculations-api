...
class Def1_IncomeSourceSpec extends UnitSpec {
  ...
  "reads" should {
    "successfully read in a model" when {
      Seq(
        ...
        s"provided downstream Def1_IncomeSourceType of $downstreamIncomeSourceType" in {
          ...
          json.as[Def1_IncomeSource] shouldBe model
        }
      }
    }
  }
