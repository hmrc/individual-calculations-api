...
class Def1_IncomeTaxSpec extends UnitSpec with JsonErrorValidators with Def1_TaxCalculationFixture {

  "have the correct fields optional" when {
    val json = (taxCalculationDownstreamJson \ "incomeTax").as[JsValue]

    testJsonAllPropertiesOptionalExcept[Def1_IncomeTax](json)(
