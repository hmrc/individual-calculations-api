...
class Def1_Nic4BandSpec extends UnitSpec with JsonErrorValidators with Def1_TaxCalculationFixture {

  "have the correct fields optional" when {
    val json = (taxCalculationDownstreamJson \ "nics" \ "class4Nics" \ "nic4Bands").head.as[JsObject]

    testJsonAllPropertiesMandatoryExcept[Def1_Nic4Band](json)("threshold", "apportionedThreshold")
  }
