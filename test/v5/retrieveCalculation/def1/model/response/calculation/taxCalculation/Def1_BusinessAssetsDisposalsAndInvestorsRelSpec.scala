...
class Def1_BusinessAssetsDisposalsAndInvestorsRelSpec extends UnitSpec with JsonErrorValidators with Def1_TaxCalculationFixture {
  ...
  "have the correct fields optional" when {
    ...
    testJsonAllPropertiesOptional[Def1_BusinessAssetsDisposalsAndInvestorsRel](json)
  }
