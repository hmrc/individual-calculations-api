...
class Def1_BenefitsInKindDetailSpec extends UnitSpec with JsonErrorValidators {

  val model: Def1_BenefitsInKindDetail = Def1_BenefitsInKindDetail(
    Some(5000.99),
    Some(5000.99),
    Some(5000.99),
    Some(5000.99),
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        downstreamJson.as[Def1_BenefitsInKindDetail] shouldBe model
      }
    }
  }
