...
class Def1_UkSavingsAndGainsIncomeSpec extends UnitSpec with JsonErrorValidators {

  val model: Def1_UkSavingsAndGainsIncome = Def1_UkSavingsAndGainsIncome(
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        downstreamJson.as[Def1_UkSavingsAndGainsIncome] shouldBe model
      }
    }
  }
