...
class Def1_SavingsAndGainsIncomeSpec extends UnitSpec with JsonErrorValidators {

  val ukModel: Def1_UkSavingsAndGainsIncome = Def1_UkSavingsAndGainsIncome(
  ...
  val foreignModel: Def1_ForeignSavingsAndGainsIncome = Def1_ForeignSavingsAndGainsIncome(
  ...
  val model: Def1_SavingsAndGainsIncome = Def1_SavingsAndGainsIncome(
    Some(100),
    Some(100),
    Some(Seq(ukModel)),
    Some(100),
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        downstreamJson.as[Def1_SavingsAndGainsIncome] shouldBe model
      }
    }
  }
