...
class Def1_ForeignSavingsAndGainsIncomeSpec extends UnitSpec with JsonErrorValidators {

  val model: Def1_ForeignSavingsAndGainsIncome = Def1_ForeignSavingsAndGainsIncome(
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        downstreamJson.as[Def1_ForeignSavingsAndGainsIncome] shouldBe model
      }
    }
  }
