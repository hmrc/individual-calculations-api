...
class Def1_DividendsIncomeSpec extends UnitSpec with JsonErrorValidators {

  val ukModel: Def1_UkDividends = Def1_UkDividends(
    Some("000000000000210"),
    Some(Def1_IncomeSourceType.`uk-dividends`),
    Some(12500),
    Some(12500)
  )

  val otherModel: Def1_OtherDividends = Def1_OtherDividends(
    Some("stockDividend"),
    Some("string"),
    Some(5000.99)
  )

  val foreignModel: Def1_CommonForeignDividend = Def1_CommonForeignDividend(
    Some(Def1_IncomeSourceType.`foreign-dividends`),
    "GER",
    Some(5000.99),
    Some(5000.99),
    Some(5000.99),
  ...
  val model: Def1_DividendsIncome = Def1_DividendsIncome(
    Some(12500),
    Some(12500),
    Some(ukModel),
    Some(Seq(otherModel)),
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        downstreamJson.as[Def1_DividendsIncome] shouldBe model
      }
    }
  }
