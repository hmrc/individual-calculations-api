...
class Def1_UkDividendsSpec extends UnitSpec with JsonErrorValidators {

  val model: Def1_UkDividends = Def1_UkDividends(
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        downstreamJson.as[Def1_UkDividends] shouldBe model
      }
    }
  }
