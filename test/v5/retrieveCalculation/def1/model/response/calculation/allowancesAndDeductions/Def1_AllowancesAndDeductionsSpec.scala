...
class Def1_AllowancesAndDeductionsSpec extends UnitSpec with EnumJsonSpecSupport {

  val model: Def1_AllowancesAndDeductions =
    Def1_AllowancesAndDeductions(
      Some(12500),
      Some(
        Def1_MarriageAllowanceTransferOut(
          1001.99,
          1001.99
        )),
      Some(12500),
      ...
      Some(1001.99),
      Some(
        Def1_AnnuityPayments(
          Some(1001.99),
          Some(1001.99)
        )),
      Some(1001.99),
      Some(
        Def1_PensionContributionsDetail(
          Some(1001.99),
          Some(1001.99),
          Some(1001.99)
        ))
  ...
  "reads" when {
    "passed valid JSON" should {
      "return a valid model" in {
        model shouldBe ifsJson.as[Def1_AllowancesAndDeductions]
      }
    }
  }
