...
import v5.retrieveCalculation.def2.model.response.inputs.{IncomeSources, Inputs, PersonalInformation}
import v5.retrieveCalculation.def2.model.response.messages.{Message, Messages}
...
import v5.retrieveCalculation.models.response.{Def2_RetrieveCalculationResponse, RetrieveCalculationHateoasData, RetrieveCalculationResponse}
