...
import v5.retrieveCalculation.def2.model.response.calculation.employmentAndPensionsIncome.{EmploymentAndPensionsIncome, EmploymentAndPensionsIncomeDetail}
import v5.retrieveCalculation.def2.model.response.calculation.endOfYearEstimate.EndOfYearEstimate
import v5.retrieveCalculation.def2.model.response.calculation.otherIncome.{OtherIncome, PostCessationIncome, PostCessationReceipt}
import v5.retrieveCalculation.def2.model.response.calculation.reliefs.{BasicRateExtension, GiftAidTaxReductionWhereBasicRateDiffers, Reliefs}
import v5.retrieveCalculation.def2.model.response.calculation.taxCalculation.{Class2Nics, IncomeTax, Nics, TaxCalculation}
import v5.retrieveCalculation.def2.model.response.calculation.taxDeductedAtSource.TaxDeductedAtSource
import v5.retrieveCalculation.def2.model.response.common.CalculationType.`inYear`
import v5.retrieveCalculation.def2.model.response.common.IncomeSourceType
import v5.retrieveCalculation.def2.model.response.inputs._
import v5.retrieveCalculation.def2.model.response.metadata.Metadata
...
trait Def2_CalculationFixture {
  ...
  val minimalCalculationR8bResponse: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
    metadata = metadata,
    inputs = inputs,
  ...
  val minimalCalculationAdditionalFieldsResponse: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
    metadata = metadata,
  ...
  val minimalCalculationCl290EnabledResponse: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
    metadata = metadata,
    inputs = inputs,
  ...
  val minimalCalculationBasicRateDivergenceEnabledResponse: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
 ...
 val calcWithoutOffPayrollWorker: Calculation = emptyCalculation.copy(reliefs= Some(reliefs),endOfYearEstimate =  Some(eoyEstimates), taxCalculation = Some(taxCalculation))
  ...
  val minimalCalculationResponse: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
    metadata = metadata,
    inputs = inputs,
    calculation = Some(calculationWithR8BData),
    messages = None
  ...
  val minimalCalculationResponseWithoutR8BData: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
    metadata = metadata,
    inputs = inputs,
    calculation = None,
    messages = None
...
""".stripMargin
  ...
  val emptyCalculationResponse: Def2_RetrieveCalculationResponse = Def2_RetrieveCalculationResponse(
    metadata = metadata,
    inputs = inputs,
