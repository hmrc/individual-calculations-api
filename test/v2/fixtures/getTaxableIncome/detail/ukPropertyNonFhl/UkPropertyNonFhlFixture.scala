...
package v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl

import play.api.libs.json.{JsValue, Json}
import v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail.LossClaimsDetailFixture._
import v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.summary.LossClaimsSummaryFixture._
import v2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.UkPropertyNonFhl
import v2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.detail.BusinessSourceAdjustableSummary
