...
package v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail

import play.api.libs.json.{JsValue, Json}
import support.UnitSpec
import v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail.ClaimNotAppliedFixture._
import v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail.DefaultCarriedForwardLossFixture._
import v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail.LossBroughtForwardFixture._
import v2.fixtures.getTaxableIncome.detail.ukPropertyNonFhl.detail.ResultOfClaimAppliedFixture._
import v2.models.response.getTaxableIncome.detail.ukPropertyNonFhl.detail.LossClaimsDetail
