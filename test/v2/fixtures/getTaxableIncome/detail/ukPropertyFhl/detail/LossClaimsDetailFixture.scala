...
import v2.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.DefaultCarriedForwardLossFixture._
import v2.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.LossBroughtForwardFixture._
import v2.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.ResultOfClaimAppliedFixture._
import v2.models.response.getTaxableIncome.detail.ukPropertyFhl.detail.LossClaimsDetail
