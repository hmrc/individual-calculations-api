...
package v2.fixtures.getTaxableIncome

import play.api.libs.json.{JsObject, JsValue, Json}
import v2.fixtures.getMetadata.MetadataResponseFixture._
import v2.fixtures.getTaxableIncome.detail.CalculationDetailFixture._
import v2.fixtures.getTaxableIncome.summary.CalculationSummaryFixture._
import v2.models.response.getTaxableIncome.TaxableIncomeResponse
