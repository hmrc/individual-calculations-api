...
package v2.fixtures.getEndOfYearEstimate

import play.api.libs.json.{JsObject, JsValue, Json}
import v2.fixtures.getEndOfYearEstimate.detail.EoyEstimateDetailFixture._
import v2.fixtures.getEndOfYearEstimate.summary.EoyEstimateSummaryFixture._
import v2.fixtures.getMetadata.MetadataResponseFixture._
import v2.models.response.getEoyEstimate.EoyEstimateResponse
