...
import v2.fixtures.getIncomeTaxAndNics.detail.pensionSavingsTaxCharges.ExcessOfLifetimeAllowanceFixture._
import v2.fixtures.getIncomeTaxAndNics.detail.pensionSavingsTaxCharges.OverseasPensionContributionsFixture._
import v2.fixtures.getIncomeTaxAndNics.detail.pensionSavingsTaxCharges.PensionContributionsInExcessOfTheAnnualAllowanceFixture._
import v2.fixtures.getIncomeTaxAndNics.detail.pensionSavingsTaxCharges.PensionSchemeOverseasTransfersFixture._
import v2.fixtures.getIncomeTaxAndNics.detail.pensionSavingsTaxCharges.PensionSchemeUnauthorisedPaymentsFixture._
import v2.models.response.getIncomeTaxAndNics.detail.pensionSavingsTaxCharges.PensionSavingsTaxChargesDetail
