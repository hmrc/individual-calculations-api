...
package v3.fixtures.listCalculations

import play.api.libs.json.{JsValue, Json}
import v3.models.response.common.{CalculationRequestor, CalculationType}
import v3.models.response.listCalculations.{CalculationListItem, ListCalculationsResponse}
...
object ListCalculationsFixture {
  ...
  import v3.fixtures.listCalculations.CalculationListItemFixture._
