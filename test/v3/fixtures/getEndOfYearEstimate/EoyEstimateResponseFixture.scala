...
package v3.fixtures.getEndOfYearEstimate

import play.api.libs.json.{JsObject, JsValue, Json}
import v3.fixtures.getEndOfYearEstimate.detail.EoyEstimateDetailFixture._
...
import v3.models.response.getEoyEstimate.EoyEstimateResponse
