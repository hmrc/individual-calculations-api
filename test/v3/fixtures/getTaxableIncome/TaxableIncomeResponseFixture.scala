...
package v3.fixtures.getTaxableIncome

import play.api.libs.json.{JsObject, JsValue, Json}
import v3.fixtures.getMetadata.MetadataResponseFixture._
import v3.fixtures.getTaxableIncome.detail.CalculationDetailFixture._
import v3.fixtures.getTaxableIncome.summary.CalculationSummaryFixture._
import v3.models.response.getTaxableIncome.TaxableIncomeResponse
