...
package v3.fixtures.getTaxableIncome.detail.selfEmployment

import play.api.libs.json.{JsValue, Json}
import v3.fixtures.getTaxableIncome.detail.selfEmployment.detail.LossClaimsDetailFixture._
import v3.fixtures.getTaxableIncome.detail.selfEmployment.summary.LossClaimSummaryFixture._
import v3.models.response.getTaxableIncome.detail.selfEmployment.SelfEmployment
import v3.models.response.getTaxableIncome.detail.selfEmployment.detail.BusinessSourceAdjustableSummary
