...
package v3.fixtures.getTaxableIncome.detail.foreignProperty

import play.api.libs.json.{JsValue, Json}
import v3.fixtures.getTaxableIncome.detail.foreignProperty.detail.LossClaimsDetailFixture._
import v3.fixtures.getTaxableIncome.detail.foreignProperty.summary.LossClaimSummaryFixture._
import v3.models.response.getTaxableIncome.detail.foreignProperty.ForeignProperty
import v3.models.response.getTaxableIncome.detail.foreignProperty.detail.BusinessSourceAdjustableSummary
