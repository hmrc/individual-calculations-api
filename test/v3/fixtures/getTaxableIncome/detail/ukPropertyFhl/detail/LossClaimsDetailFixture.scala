...
import v3.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.DefaultCarriedForwardLossFixture._
import v3.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.LossBroughtForwardFixture._
import v3.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.ResultOfClaimAppliedFixture._
import v3.models.response.getTaxableIncome.detail.ukPropertyFhl.detail.LossClaimsDetail
