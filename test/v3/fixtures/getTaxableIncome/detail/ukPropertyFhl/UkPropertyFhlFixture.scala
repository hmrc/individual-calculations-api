...
package v3.fixtures.getTaxableIncome.detail.ukPropertyFhl

import play.api.libs.json.{ JsValue, Json }
import v3.fixtures.getTaxableIncome.detail.ukPropertyFhl.detail.LossClaimsDetailFixture._
import v3.fixtures.getTaxableIncome.detail.ukPropertyFhl.summary.LossClaimSummaryFixture._
import v3.models.response.getTaxableIncome.detail.ukPropertyFhl.UkPropertyFhl
import v3.models.response.getTaxableIncome.detail.ukPropertyFhl.detail.BusinessSourceAdjustableSummary
...
object UkPropertyFhlFixture {
  ...
  val adjustedIncomeTaxLoss: Option[BigInt]                      = Some(1007)
  val taxableProfit: Option[BigInt]                              = Some(1008)
  val taxableProfitAfterIncomeTaxLossesDeduction: Option[BigInt] = Some(1009)
