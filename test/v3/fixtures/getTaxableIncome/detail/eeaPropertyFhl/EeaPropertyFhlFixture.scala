...
package v3.fixtures.getTaxableIncome.detail.eeaPropertyFhl

import play.api.libs.json.{ JsValue, Json }
import v3.fixtures.getTaxableIncome.detail.eeaPropertyFhl.detail.LossClaimsDetailFixture.{ lossClaimsDetailJson, lossClaimsDetailModel }
import v3.fixtures.getTaxableIncome.detail.eeaPropertyFhl.summary.LossClaimSummaryFixture.{ lossClaimSummaryJson, lossClaimsSummaryModel }
import v3.models.response.getTaxableIncome.detail.eeaPropertyFhl.EeaPropertyFhl
import v3.models.response.getTaxableIncome.detail.eeaPropertyFhl.detail.BusinessSourceAdjustableSummary
