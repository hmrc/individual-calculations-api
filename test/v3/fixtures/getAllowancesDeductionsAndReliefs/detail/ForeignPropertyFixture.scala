...
import v3.fixtures.getAllowancesDeductionsAndReliefs.detail.ForeignPropertyRfcDetailFixture._
import v3.models.response.getAllowancesDeductionsAndReliefs.detail.ForeignProperty

object ForeignPropertyFixture {

  val totalForeignPropertyAllowableAmount: BigDecimal = 15000.99
