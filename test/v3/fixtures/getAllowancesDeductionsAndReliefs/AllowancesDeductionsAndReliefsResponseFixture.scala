...
package v3.fixtures.getAllowancesDeductionsAndReliefs

import play.api.libs.json.{JsObject, JsValue, Json}
import v3.fixtures.getAllowancesDeductionsAndReliefs.detail.CalculationDetailFixture._
import v3.fixtures.getAllowancesDeductionsAndReliefs.summary.CalculationSummaryFixture._
import v3.fixtures.getMetadata.MetadataResponseFixture._
import v3.models.response.getAllowancesDeductionsAndReliefs.AllowancesDeductionsAndReliefsResponse
import v3.models.response.getAllowancesDeductionsAndReliefs.detail.CalculationDetail
import v3.models.response.getAllowancesDeductionsAndReliefs.summary.CalculationSummary
