...
import v3.fixtures.getIncomeTaxAndNics.detail.capitalGainsTax.CgtTaxBandFixture._
import v3.models.response.getIncomeTaxAndNics.detail.capitalGainsTax.{CgtTaxBandName, ResidentialPropertyAndCarriedInterest}
