...
import v3.fixtures.getMessages.MessagesResponseFixture
import v3.fixtures.getMessages.MessagesResponseFixture._
...
class GetMessagesControllerISpec extends V3IntegrationBaseSpec {
