...
class ListCalculationsEnablementControllerISpec extends IntegrationBaseSpec with Def3_ListCalculationsFixture {

  override def servicesConfig: Map[String, Any] =
    Map(
      s"api.7.0.endpoints.enabled" -> "true",
      s"api.7.0.status" -> "RETIRED"
