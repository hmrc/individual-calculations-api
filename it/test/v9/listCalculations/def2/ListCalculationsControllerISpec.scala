...
import v9.listCalculations.def2.model.Def2_ListCalculationsFixture
...
class ListCalculationsControllerISpec extends IntegrationBaseSpec with Def2_ListCalculationsFixture {
  ...
  private trait Test {
    ...
    val mtdTaxYear: String        = TaxYear.ending(2025).asMtd
  ...
  "Calling the list calculations endpoint for a 2024-25 tax year" should {
    ...
    "return error according to spec" when {
      "validation error" when {
        ...
        val input = Seq(
          ("AA1123A", "2024-25", None, BAD_REQUEST, NinoFormatError),
          ...
          ("ZG903729C", "2024-25", Some("invalid-calc-type"), BAD_REQUEST, FormatCalculationTypeError)
        )
